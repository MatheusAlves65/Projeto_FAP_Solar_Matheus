...
float adc_init_voltage(void) { // Configurando a resolução do ADC para a leitura de voltagem
    float tensao;
...
float adc_init_current (void) { // Configurando a resolução do ADC para leitura da corrente
